...
import 'package:gomma_prayer/screens/conference_meeting_screen.dart';
import 'package:gomma_prayer/screens/one_to_one_screen.dart';
import 'package:gomma_prayer/utils/api.dart';
import 'package:gomma_prayer/utils/spacer.dart';
import 'package:gomma_prayer/utils/toast.dart';
import 'package:gomma_prayer/widgets/common/joining_details/joining_details.dart';
...
class _JoinScreenState extends State<JoinScreen> {
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: MaterialButton(
                                ...
                                color: purple,
                                child: const Text("Recoreded Meeting",
  ...
  void _getRecorded() async {
    var rooms = await fetchRooms(_token);
    ...
    if (rooms.isNotEmpty) {
          ...
          content: Padding(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) => ListTile(
                title: Text('${rooms[index]["user"]['name']}'),
                onTap: () async {
                  var recordedList =
                      await fetchRecordings(_token, rooms[index]["roomId"]);
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (_) => Scaffold(
                              body: SafeArea(
                                child: recordedList.isNotEmpty
                                    ? ListView.builder(
                                        itemCount: recordedList.length,
                                        itemBuilder: (context, index) {
                                          return ListTile(
                                            title: Text(
                                                recordedList[index]["roomId"]),
                                          );
                                        })
                                    : Text('No Vidoes'),
                              ),
      ...
      AlertDialog(
        content: Text("There Is No Rooms"),
      );
    }
  }
